      ...
      <MainGraphismeContainer>
        ...
        <GraphismeContainer>
          ...
          >
            ...
            petit, j’adore la création, lorsque j’étais en primaire, j’aimais
            beaucoup dessiner et faire de la peinture, j’étais très manuel.
            C’est au collège que j’ai commencé à toucher à de la création
            digitale, dès le collège à travers des montages de vidéos sur
            YouTube. C’est à partir de là que j’ai développé une grande
            admiration pour le cinéma et notamment sur la postproduction, en
            particulier les effets spéciaux. C’est en m’intéressant au métier de
            vfx artist que je découvre le motion design. Au même moment, je
            participais au développement d’associations esport qui m’ont donné
            l’oppor-tunité de me lancer dans le motion design et le graphisme.
          </DescriptionAbout>
        </GraphismeContainer>
      </MainGraphismeContainer>
      <MainExperienceContainer>
        <ExperienceContainer>
          ...
          >
            ...
            des projets de musiques et de web series. Après 2 ans chez InFuria,
            je suis rentré à Paris Ynov Campus pour développer mon sens créatif
            et mes qualités technique. Au même moment, je rejoins l’assoication
            BeHard Esport en tant que motion designer et graphiste. Quelques
            mois après, je deviens directeur artistique de l’association ou je
            dirige une petite équipe de 4 créatifs. Avec BeHard, j’ai eu
            l’occasion de développé plusieurs identités visuelles, plusieurs
            vidéos de communications (montage vidéo, motion design et production
            3D) et une collection textile autour de l’équipe.
          </DescriptionAbout>
        </ExperienceContainer>
      </MainExperienceContainer>
